 ...
 <h3>
  ...
  <h5>
    <p>
      ...
      &nbsp;<img src="https://https://fontawesome.com/images/favicon/icon.svg" alt="fontawesome" width="35" height="35" title="Font Awesome"/> &nbsp;<img src="https://raw.githubusercontent.com/devicons/devicon/master/icons/javascript/javascript-original.svg" alt="javascript" width="35" height="35" title="JavaScript"/>
    </p>
  </h5>
</div>
...
This is my solution to the REST Countries API with color theme switcher challenge on Frontend Mentor. The goal of this challenge is to integrate with the [REST Countries V3.1 API](https://restcountries.com/#endpoints-latest-added-enpoint) to pull country data and display it like in the designs.
